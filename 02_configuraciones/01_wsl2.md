...
:warning: Si al ingresar a la `Terminal` no puede ver `Ubuntu`, entonces, se puede ingresar escribiendo el comando `wsl -d ubuntu` o especificado la versión si la conoce `wsl -d Ubuntu-22.04`.  
